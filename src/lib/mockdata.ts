...
export const piani: PianoConfig[] = [
  {
    ...
    maxClienti: 100,
    maxFatture: 50,
    funzionalita: ['CRM Base', 'Fatturazione', 'Magazzino', 'Supporto Email'],
  },
  {
    id: 'professional',
    nome: 'Professional',
    ...
    maxClienti: 500,
    maxFatture: 200,
    funzionalita: ['CRM Avanzato', 'Fatturazione', 'Magazzino', 'E-commerce', 'Payroll', 'Supporto Prioritario'],
  },
  {
    id: 'premium',
    nome: 'Premium',
    ...
    maxClienti: -1,
    maxFatture: -1,
    funzionalita: ['Tutto incluso', 'API Access', 'Multi-sede', 'Supporto Dedicato', 'White Label'],
  },
];
